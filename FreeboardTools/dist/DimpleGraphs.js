...
(function()
{
	...
	freeboard.loadWidgetPlugin({
		...
		"external_scripts": [getAbsolutePath() + "/dimple.v2.1.3.min.js"],
	...
	function getAbsolutePath() {
	    ...
	    var x = loc.href.substring(0, loc.href.length - ((loc.pathname + loc.search + loc.hash).length - pathName.length));
	    alert(x);
	    return x;
	}
